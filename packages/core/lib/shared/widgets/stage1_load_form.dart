...
class _Stage1LoadFormState extends ConsumerState<Stage1LoadForm> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!_moliendaInitialized &&
      ...
      final match = moliendasDisponibles
          .firstWhereOrNull((m) => m.id == widget.initialData!.moliendaId);
      if (match != null) {
            ...
            children: [
              ...
              CustomFromDropdown<BasketSize>(
                ...
                items: BasketSize.values.map((s) {
                  final inventoryItem = canastillasInventario
                      .firstWhereOrNull((i) => i.size == s);
