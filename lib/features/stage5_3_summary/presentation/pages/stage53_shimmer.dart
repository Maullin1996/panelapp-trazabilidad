...
class Stage53Shimmer extends StatefulWidget {
  final int itemCount;
  const Stage53Shimmer({super.key, this.itemCount = 6});

  @override
  State<Stage53Shimmer> createState() => _Stage52ShimmerState();
}

class _Stage52ShimmerState extends State<Stage53Shimmer>
