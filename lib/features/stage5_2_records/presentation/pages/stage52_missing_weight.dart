...
import 'package:registro_panela/features/stage5_1_missing_weight/presentation/providers/providers.dart';
import 'package:registro_panela/core/theme/utils/tokens.dart';
import 'package:registro_panela/shared/widgets/widgets.dart';
import 'package:registro_panela/features/stage1_delivery/domain/entities/stage1_form_data.dart';

class Stage52MissingWeight extends ConsumerStatefulWidget {
  final String projectId;
  const Stage52MissingWeight({super.key, required this.projectId});

  @override
  ConsumerState<Stage52MissingWeight> createState() =>
      _Stage5MissingWeightState();
}

class _Stage5MissingWeightState extends ConsumerState<Stage52MissingWeight> {
