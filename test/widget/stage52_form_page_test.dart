...
void main() {
  testWidgets('Stage52FormPage shows new record title and fields', (
    tester,
  ) async {
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: const MaterialApp(home: Stage52FormPage(projectId: 'p1')),
      ),
    );
  ...
  testWidgets('Stage52FormPage shows edit title when id is provided', (
    tester,
  ) async {
    await tester.pumpWidget(
      ProviderScope(
