...
Stage3FormData _load3({
  required String id,
  required String load2Id,
  int baskets = 0,
  double weight = 0,
}) {
...
void main() {
  test('stage3GlobalSummary agrega totales esperados y registrados', () {
    final loads2 = [
      _load2(id: 'l1', projectId: 'p1', count: 3, referenceWeight: 12),
      _load2(id: 'l2', projectId: 'p1', count: 2, referenceWeight: 10),
      _load2(id: 'other', projectId: 'p2', count: 10, referenceWeight: 10),
    ];
    ...
    expect(summary.totalExpectedCount, 5); // 3 + 2
    expect(summary.totalExpectedWeight, 3 * 12 + 2 * 10); // 56
